...
| BK-1004 | Package has not been missing long enough | Agent explains automatic replacement is not yet available under policy and may offer support escalation if urgent |
...
- Human-help requests escalate once an order can be tied to the case.
- Frustration and urgency are fuzzy signals. The demo tracks them in workflow state and escalates after two signals.
